...
t_coordinate	move_map_center_to_origin(t_coordinate vertex, t_map_info map_info);
t_coordinate	move(t_coordinate vertex, int x, int y);
t_coordinate	zoom(t_coordinate vertex, int scale);
t_coordinate	translate(t_coordinate vertex, t_map_info map_info, double base[3][3]);
