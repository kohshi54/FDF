...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/30 20:53:17 by kyamaguc          #+#    #+#             */
/*   Updated: 2023/05/30 20:53:17 by kyamaguc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double	set_initial_scale(t_map_info map_info)
{
	...
	if (map_info.width <= map_info.height && map_info.depth <= map_info.height)
		max = map_info.height;
	else if (map_info.height <= map_info.depth && \
				map_info.width <= map_info.depth)
		max = map_info.depth;
	else if (map_info.depth <= map_info.width && \
